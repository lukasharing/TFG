...
\begin{figure}[H]
  \centering
  \captionsetup{justification=centering}%,margin=2cm
  \subfloat[Intensidad especular con \(h_0\)]{\includegraphics[width=0.33\textwidth]{secciones/imagenes/especular-0.jpeg}\label{fig:specular-0}}
  \subfloat[Intensidad especular con \(h_1\)]{\includegraphics[width=0.33\textwidth]{secciones/imagenes/especular-1.jpeg}\label{fig:specular-1}}
  \subfloat[Intensidad especular con \(h_3\)]{\includegraphics[width=0.33\textwidth]{secciones/imagenes/especular-2.jpeg}\label{fig:specular-2}}
