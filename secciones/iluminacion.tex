...
\begin{figure}[H]
  \centering
  \captionsetup{justification=centering}%,margin=2cm
  \subfloat[Intensidad especular con \(h_0\)]{\includegraphics[width=0.30\textwidth]{secciones/imagenes/lightmodel/especular-0.png}\label{fig:specular-0}}
  \hfill
  \subfloat[Intensidad especular con \(h_1\)]{\includegraphics[width=0.30\textwidth]{secciones/imagenes/lightmodel/especular-1.png}\label{fig:specular-1}}
  \hfill
  \subfloat[Intensidad especular con \(h_3\)]{\includegraphics[width=0.30\textwidth]{secciones/imagenes/lightmodel/especular-2.png}\label{fig:specular-2}}
...
% https://www.shadertoy.com/view/wtlBWr
