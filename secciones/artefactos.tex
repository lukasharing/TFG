...
\begin{figure}[H]
  \centering
  \subfloat[Se estima dentro de la superficie]{\includegraphics[width=0.45\textwidth]{secciones/imagenes/estimation/sin_sobreestimacion_interior.png}\label{fig:estima_dentro}}
  \hfill
