...
\begin{figure}[H]
  \centering
  \captionsetup{justification=centering}%,margin=2cm
  \subfloat[Imagen original]{\includegraphics[width=0.45\textwidth]{secciones/imagenes/preliminars/pol8-img-left.png}\label{fig:white}}
  \hfill
  \subfloat[\(f\) aplicada sobre la imagen original]{\includegraphics[width=0.45\textwidth]{secciones/imagenes/preliminars/pol8-img-right.png}\label{fig:black}}
  \caption{Aplicación de un homeomorfismo a una imagen de grises.}
\end{figure}
% https://www.shadertoy.com/view/wljfR1
...
\begin{figure}[H]
  \centering
  \captionsetup{justification=centering}%,margin=2cm
  \subfloat[Imagen \(f(x)\)]{\includegraphics[width=0.30\textwidth]{secciones/imagenes/preliminars/texture-wall.png}\label{fig:left}}
  \hfill
  \subfloat[Imagen \(g(x)\)]{\includegraphics[width=0.30\textwidth]{secciones/imagenes/preliminars/texture-galaxy.png}\label{fig:right}}
  \hfill
  \subfloat[Máscara \(t\)]{\includegraphics[width=0.30\textwidth]{secciones/imagenes/preliminars/mask.png}\label{fig:result}}
...
\begin{figure}[H]
  \centering
  \captionsetup{justification=centering}%,margin=2cm
  \subfloat[Interpolación con el homomorfismo \(p(t)=t\)]{\includegraphics[width=0.45\textwidth]{secciones/imagenes/preliminars/masking-result-1.png}\label{fig:result1}}
  \hfill
  \subfloat[Interpolación con el homomorfismo \(p(t)=t^4\)]{\includegraphics[width=0.45\textwidth]{secciones/imagenes/preliminars/masking-result-2.png}\label{fig:result2}}
  \caption{Interpolaciones con distintos homomorfismos.}
\end{figure}

% https://www.shadertoy.com/view/wt2fR1