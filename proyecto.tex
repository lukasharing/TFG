...
% Fuente
%\setmainfont[%Contextuals=Alternate,SmallCapsFeatures={LetterSpace=1}]%{EBGaramond}
...
\begin{document}
	...
	% Marcher
	\input{secciones/marcher}
	% Iluminacion
	\input{secciones/iluminacion}
    % Funciones de Distancia con Signo
	\input{secciones/FDS}
	% Artefactos
	\input{secciones/artefactos}
	% Materiales
	\input{secciones/materiales}
